...
try{
const response = await deleteTask({subTaskId:task._id,taskId:id})
    ...
    <>
      <div>
        <Menu as='div' className='relative inline-block text-left'>
          <Menu.Button className='inline-flex w-full justify-center rounded-md px-4 py-2 text-sm font-medium text-gray-100 '>
            <BsThreeDots />
          </Menu.Button>
      ...
      <EditSubTask open={openEdit} setOpen={setOpenEdit} id={task._id} />
